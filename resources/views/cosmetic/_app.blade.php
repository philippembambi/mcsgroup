...
<html lang="fr">
    <head>
        ...
        <meta name="description" content="Cosmetics : Le soin de la beauté idéale">
        ...
        <link rel="stylesheet" href="{{ asset('cosmetic/css/shop.css') }}">
        <link rel="stylesheet" href="{{ asset('cosmetic/css/custom.css') }}">
