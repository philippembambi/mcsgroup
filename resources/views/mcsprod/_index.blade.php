            ...
            <div class="container">
              <div class="detail-box">
                <h3 style="font-size: 42px;">
                  ...
                  Mcs Prod <br>
                    Capture d'images évenementielles
                </h3>
                <div>
                <a href="{{ url('user.authenticate') }}">
                    Rejoignez-nous
  ...
  <section class="find_section">
    <div class="container">
      <form action="">
        <div class=" form-row">
          <div class="col-lg-3">
            <label for="carPark">Selectionner un service</label>
            <select name="" id="carPark" class="form-control">
              <option value="prisevue">Prise des vues</option>
              <option value="montage">Montage vidéo et sonore</option>
              <option value="autre">Autre</option>
            </select>
          </div>
          <div class="col-lg-3">
            <label for="parkingName">Téléphone ou E-mail</label>
            <input type="text" class="form-control" placeholder="" id="parkingName">
          </div>

          <div class="col-lg-3">
            <label for="parkingNumber">Numéro de téléphone</label>
            <input type="text" class="form-control" placeholder="Exemple : +33 659598750" id="parkingNumber">
          </div>
          <div class="col-lg-3">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <div class="box">
            <div class="img-box">
              <img src="{{  asset('image/icon_Instagram_100px.png') }}" alt="">
            </div>
            <div class="detail-box">
              <h5>
        ...
        <div class="col-md-4">
          <div class="box">
            <div class="img-box">
              <img src="{{  asset('image/icon_Video Camera_100px.png') }}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Save Time
        ...
        <div class="col-md-4">
          <div class="box">
            <div class="img-box">
              <img src="{{  asset('image/icon_Video Trimming_100px.png') }}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Save Stress
