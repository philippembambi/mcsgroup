...
function passwordStrengthCheck(password1, password2, passwordsInfo)
{
	...
	$(password1).on('keyup', function(e) {
    	...
    	{
			passwordsInfo.removeClass().addClass('stillweakpass').html("Encore faible ! (Au moins un chiffre est souhaitable !)");
    	}
		else
		{
			passwordsInfo.removeClass().addClass('weakpass').html("Très faible ! (Saisissez au moins 5 caractères)");
		}
	});
	...
	$(password2).on('keyup', function(e) {
		...
		{
			passwordsInfo.removeClass().addClass('weakpass').html("Mot de passe de confirmation erroné !");
		}else{
			passwordsInfo.removeClass().addClass('goodpass').html("Mot de passe de confirmation réussi !");
		}
